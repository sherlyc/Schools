  ...
  return knex('profiles').del()
        ...
        .then(function () {
            ...
            return Promise.all([
                ...
                knex('schools').insert({name: "Adventure School", schoolType: 'Full Primary School (Year 1-8)', authority: 'State', gender: 'Co-Educational', decile: '10'}),
                ...
                knex('locations').insert({latitude: "-41.313832", longitude: "174.795985", suburb: "Kilbirnie", school_id:'1'}),
                knex('locations').insert({latitude: "-41.275422", longitude: "174.780672", suburb: "Thorndon", school_id:'2'}),
